...
struct card epcList[3] = {card1, card2, card3}; // create a list of UHF card
uint16_t epcListSize = sizeof(epcList) / sizeof(struct card); // calculate the size of the epcList array
